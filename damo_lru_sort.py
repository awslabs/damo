...
plrus_params = [
    'kdamond_pid', 'enabled', 'hot_thres_access_freq', 'cold_min_age',
    'quota_ms', 'quota_reset_interval_ms', 'wmarks_interval', 'wmarks_high',
    'wmarks_mid', 'wmarks_low', 'sample_interval', 'aggr_interval',
    'min_nr_regions', 'max_nr_regions', 'monitor_region_start',
    'monitor_region_end', 'nr_lru_sort_tried_hot_regions',
    'nr_lru_sorted_hot_regions', 'bytes_lru_sort_tried_hot_regions',
    'bytes_lru_sorted_hot_regions', 'nr_lru_sort_tried_cold_regions',
    'nr_lru_sorted_cold_regions', 'bytes_lru_sort_tried_cold_regions',
...
def set_argparser(parser):
    ...
    parser.add_argument('--monitor_intervals',
                        type=int,
                        metavar='<microseconds>',
                        nargs=2,
                        default=[None] * 2,

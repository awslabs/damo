...
class TestDamoFmtStr(unittest.TestCase):
    ...
    def test_format_time(self):
        ...
        day_ns = 24 * hour_ns
        _test_damo_common.test_input_expects_funcs(
            self, [
                ...
                123456789123: ['2 m 3 s 456 ms 789 us 123 ns', '2 m 3.457 s'],
                ...
                2 * hour_ns: ['2 h', '2 h'],
                3 * day_ns + 2 * hour_ns + 1 * minute_ns + 59 * sec_ns + 123 * msec_ns:
        ...
        for input_ in [123, 1234, 12345, 123456]:
            for func in [
                    _damo_fmt_str.format_time_us, _damo_fmt_str.format_time_ms
            ]:
                self.assertEqual(func(input_, True), '%s' % input_)

    def test_format_ratio(self):
        _test_damo_common.test_input_expects(
            self, lambda x: _damo_fmt_str.format_ratio(x, False), {
                123: '12,300 %',
    ...
    def test_format_permil(self):
        _test_damo_common.test_input_expects(
            self, lambda x: _damo_fmt_str.format_permil(x, False), {
                123000: '12,300 %',
    ...
    def test_text_to_time(self):
        ...
        _test_damo_common.test_input_expects(
            self, _damo_fmt_str.text_to_sec, {
                '134': 134,
                'max': _damo_fmt_str.ulong_max,
                '123': 123,
                '123.456': 123.456,
    ...
    def test_text_to_percent(self):
        _test_damo_common.test_input_expects(
            self, _damo_fmt_str.text_to_percent, {
                '10%': 10.0,
                12.34: 12.34,
                '12.34': 12.34,
                '12.34%': 12.34,
    ...
    def test_text_to_permil(self):
        _test_damo_common.test_input_expects(
            self, _damo_fmt_str.text_to_permil, {
                '10%': 100.0,
                12.34: 12.34,
                '12.34': 12.34,
                '1.234%': 12.34,
    ...
    def test_text_to_ratio(self):
        _test_damo_common.test_input_expects(
            self, _damo_fmt_str.text_to_ratio, {
                '10%': 0.1,
                '12.34%': 0.1234,
                '200%': 2.0,
                0.5: 0.5,
    ...
    def test_text_to_bytes(self):
        _test_damo_common.test_input_expects(
            self, _damo_fmt_str.text_to_bytes, {
                '123': 123,
                '1,234': 1234,
                '123 B': 123,
                '2 K': 2048,
    ...
    def test_text_to_bool(self):
        _test_damo_common.test_input_expects(
            self, _damo_fmt_str.text_to_bool, {
                True: True,
                False: False,
                'Y': True,
                'y': True,

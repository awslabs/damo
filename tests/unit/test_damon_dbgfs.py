...
class TestDamonDbgfs(unittest.TestCase):
    ...
    def test_debugfs_output_to_damos(self):
        ...
        _test_damo_common.test_input_expects(
            self, lambda x: _damon_dbgfs.debugfs_output_to_damos(
                x, _damon.DamonIntervals(5000, 100000, 1000000)),
            {
                ...
                _damon.Damos(access_pattern=_damon.DamosAccessPattern(
                    [4096, 18446744073709551615], [0.0, 0.0],
                    _damon.unit_percent, [1000000.0, 4294900000.0],
                    _damon.unit_usec),
                             action='stat',
    ...
    def test_files_content_to_kdamonds(self):
        ...
        _test_damo_common.test_input_expects(
            self, lambda x: _damon_dbgfs.wops_for_kdamonds(

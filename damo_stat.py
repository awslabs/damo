...
subcmds = [
    _damo_subcmds.DamoSubCmd(name='kdamonds',
                             module=damo_stat_kdamonds,
                             msg='detailed status of kdamonds'),
    _damo_subcmds.DamoSubCmd(name='regions',
                             module=damo_stat_regions,
    ...
    _damo_subcmds.DamoSubCmd(name='damon_interface',
                             module=_damo_subcmds.DamoSubCmdModule(
                                 None, pr_damon_interface),
...
def set_argparser(parser):
    subparsers = parser.add_subparsers(title='stat type',
                                       dest='stat_type',
                                       metavar='<stat type>',
                                       help='the type of the stat to show')
